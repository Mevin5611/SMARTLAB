...
public class view_key_logs extends AppCompatActivity {
    ListView li;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_key_logs);
        li=findViewById(R.id.lv);
        li=findViewById(R.id.lv);
        sh = PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
        ip = sh.getString("url", "");
        url = ip + "/view_key_logs";
...
//                                li.setAdapter(new blocked_apps(getApplicationContext(),name));//custom_view_service.xml and li is the listview object
                                li.setAdapter(new custom_view_key_logs(getApplicationContext(), date, time, key) {
                                    @Override
